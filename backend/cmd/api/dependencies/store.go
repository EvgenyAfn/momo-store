	...
	packs := []dumplings.Product{
		{
			...
			Price:       5.00,
			Image:       "https://storage.yandexcloud.net/ayudaev-images/momo1",
		},
		{
			ID:          2,
			Name:        "Хинкали",
			...
			Price:       3.50,
			Image:       "https://storage.yandexcloud.net/ayudaev-images/momo2",
		},
		{
			ID:          3,
			Name:        "Манты",
			...
			Price:       2.75,
			Image:       "https://storage.yandexcloud.net/ayudaev-images/momo3",
		},
		{
			ID:          4,
			Name:        "Буузы",
			...
			Price:       4.00,
			Image:       "https://storage.yandexcloud.net/ayudaev-images/momo4",
		},
		{
			ID:          5,
			Name:        "Цзяоцзы",
			...
			Price:       7.25,
			Image:       "https://storage.yandexcloud.net/ayudaev-images/momo5",
		},
		{
			ID:          6,
			Name:        "Гедза",
			...
			Price:       3.50,
			Image:       "https://storage.yandexcloud.net/ayudaev-images/momo6",
		},
		{
			ID:          7,
			Name:        "Дим-самы",
			Description: "С уткой",
			Price:       2.65,
			Image:       "https://storage.yandexcloud.net/ayudaev-images/momo7",
		},
		{
			ID:          8,
			Name:        "Момо",
			...
			Price:       5.00,
			Image:       "https://storage.yandexcloud.net/ayudaev-images/momo8",
		},
		{
			ID:          9,
			Name:        "Вонтоны",
